...
class Block(graph_4762: Graph, id_4762: Long /*cf https://github.com/scala/bug/issues/4762 */ )
  ...
  /** Traverse to MACRO_DECL via AST OUT edge.
    */
  def _macroDeclViaAstOut: overflowdb.traversal.Traversal[MacroDecl] = get()._macroDeclViaAstOut
  ...
  /** Traverse to MACRO_DECL via AST IN edge.
    */
  def _macroDeclViaAstIn: MacroDecl = get()._macroDeclViaAstIn
...
class BlockDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode with Expression with BlockBase {
  ...
  def _macroDeclViaAstOut: overflowdb.traversal.Traversal[MacroDecl]               = astOut.collectAll[MacroDecl]
  ...
  def inMacroOut: Iterator[MacroDecl] = createAdjacentNodeScalaIteratorByOffSet[MacroDecl](6)
  override def _inMacroOut            = createAdjacentNodeScalaIteratorByOffSet[StoredNode](6)
  ...
  def _macroDeclViaAstIn: MacroDecl = try { astIn.collectAll[MacroDecl].next() }
  catch {
    case e: java.util.NoSuchElementException =>
      throw new overflowdb.SchemaViolationException(
        "IN edge with label AST to an adjacent MACRO_DECL is mandatory, but not defined for this BLOCK node with id=" + id,
        e
      )
  }
  ...
  def containsIn: Iterator[AstNode] = createAdjacentNodeScalaIteratorByOffSet[AstNode](15)
  ...
  def lengthIn: Iterator[Type] = createAdjacentNodeScalaIteratorByOffSet[Type](17)
  override def _lengthIn       = createAdjacentNodeScalaIteratorByOffSet[StoredNode](17)

  def lengthExpIn: Iterator[Type] = createAdjacentNodeScalaIteratorByOffSet[Type](18)
  override def _lengthExpIn       = createAdjacentNodeScalaIteratorByOffSet[StoredNode](18)
  ...
  def reachingDefIn: Iterator[Expression] = createAdjacentNodeScalaIteratorByOffSet[Expression](20)
