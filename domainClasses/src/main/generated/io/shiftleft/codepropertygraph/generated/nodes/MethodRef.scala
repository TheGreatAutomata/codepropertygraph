...
class MethodRef(graph_4762: Graph, id_4762: Long /*cf https://github.com/scala/bug/issues/4762 */ )
  ...
  /** Traverse to MACRO_DECL via CONTAINS IN edge.
    */
  def _macroDeclViaContainsIn: overflowdb.traversal.Traversal[MacroDecl] = get()._macroDeclViaContainsIn
...
class MethodRefDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode with Expression with MethodRefBase {
  ...
  def inMacroOut: Iterator[MacroDecl] = createAdjacentNodeScalaIteratorByOffSet[MacroDecl](7)
  override def _inMacroOut            = createAdjacentNodeScalaIteratorByOffSet[StoredNode](7)
  ...
  def taggedByOut: Iterator[Tag]                              = createAdjacentNodeScalaIteratorByOffSet[Tag](11)
  override def _taggedByOut                                   = createAdjacentNodeScalaIteratorByOffSet[StoredNode](11)
  def _tagViaTaggedByOut: overflowdb.traversal.Traversal[Tag] = taggedByOut.collectAll[Tag]

  def argumentIn: Iterator[Expression]     = createAdjacentNodeScalaIteratorByOffSet[Expression](12)
  ...
  def cdgIn: Iterator[CfgNode]                              = createAdjacentNodeScalaIteratorByOffSet[CfgNode](14)
  override def _cdgIn                                       = createAdjacentNodeScalaIteratorByOffSet[StoredNode](14)
  ...
  def containsIn: Iterator[AstNode] = createAdjacentNodeScalaIteratorByOffSet[AstNode](17)
  override def _containsIn          = createAdjacentNodeScalaIteratorByOffSet[StoredNode](17)
  def _macroDeclViaContainsIn: overflowdb.traversal.Traversal[MacroDecl] = containsIn.collectAll[MacroDecl]
  def _methodViaContainsIn: overflowdb.traversal.Traversal[Method]       = containsIn.collectAll[Method]

  def dominateIn: Iterator[CfgNode] = createAdjacentNodeScalaIteratorByOffSet[CfgNode](18)
  override def _dominateIn          = createAdjacentNodeScalaIteratorByOffSet[StoredNode](18)
  ...
  def lengthIn: Iterator[Type] = createAdjacentNodeScalaIteratorByOffSet[Type](19)
  override def _lengthIn       = createAdjacentNodeScalaIteratorByOffSet[StoredNode](19)

  def lengthExpIn: Iterator[Type] = createAdjacentNodeScalaIteratorByOffSet[Type](20)
  override def _lengthExpIn       = createAdjacentNodeScalaIteratorByOffSet[StoredNode](20)
  ...
  def reachingDefIn: Iterator[CfgNode] = createAdjacentNodeScalaIteratorByOffSet[CfgNode](22)
  override def _reachingDefIn          = createAdjacentNodeScalaIteratorByOffSet[StoredNode](22)
