...
class CallDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode with CallRepr with Expression with CallBase {
  ...
  def lengthIn: Iterator[Type] = createAdjacentNodeScalaIteratorByOffSet[Type](21)
  override def _lengthIn       = createAdjacentNodeScalaIteratorByOffSet[StoredNode](21)

  def lengthExpIn: Iterator[Type] = createAdjacentNodeScalaIteratorByOffSet[Type](22)
  override def _lengthExpIn       = createAdjacentNodeScalaIteratorByOffSet[StoredNode](22)

  def postDominateIn: Iterator[CfgNode] = createAdjacentNodeScalaIteratorByOffSet[CfgNode](23)
  override def _postDominateIn          = createAdjacentNodeScalaIteratorByOffSet[StoredNode](23)
  ...
  def reachingDefIn: Iterator[CfgNode] = createAdjacentNodeScalaIteratorByOffSet[CfgNode](24)
  override def _reachingDefIn          = createAdjacentNodeScalaIteratorByOffSet[StoredNode](24)
