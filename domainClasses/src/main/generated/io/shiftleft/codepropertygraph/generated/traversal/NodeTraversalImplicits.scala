...
class StoredNodeTraversalExtGen[NodeType <: StoredNode](val traversal: Iterator[NodeType]) extends AnyVal {
  ...
  def _lReferenceOfOut: Iterator[StoredNode]    = traversal.flatMap { _._lReferenceOfOut }
  def _lReferenceOfIn: Iterator[StoredNode]     = traversal.flatMap { _._lReferenceOfIn }
  ...
  def _lengthExpOut: Iterator[StoredNode]       = traversal.flatMap { _._lengthExpOut }
  def _lengthExpIn: Iterator[StoredNode]        = traversal.flatMap { _._lengthExpIn }
  ...
  def _rReferenceOfOut: Iterator[StoredNode]    = traversal.flatMap { _._rReferenceOfOut }
  def _rReferenceOfIn: Iterator[StoredNode]     = traversal.flatMap { _._rReferenceOfIn }
