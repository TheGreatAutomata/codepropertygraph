...
object Import {
  ...
  object Edges {
    ...
    val In: Array[String]  = Array("AST", "IS_CALL_FOR_IMPORT", "LENGTH", "LENGTH_EXP", "SPECIALIZE_PARA")
  }
...
class ImportDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode with AstNode with ImportBase {
  ...
  def isCallForImportIn: Iterator[Call] = createAdjacentNodeScalaIteratorByOffSet[Call](4)
  override def _isCallForImportIn       = createAdjacentNodeScalaIteratorByOffSet[StoredNode](4)
